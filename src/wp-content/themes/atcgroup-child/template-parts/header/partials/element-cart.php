...
<span class="header-cart-title">
  <?php if($cart_title) { ?> <?php _e('Danh sách của bạn', 'woocommerce'); ?> <?php } ?>
...
<?php if($cart_style == 'off-canvas') { ?>
  ...
  <div class="cart-popup-inner inner-padding cart-custom">
      <div class="cart-popup-title">
          <h4 class="cart-title"><?php _e('Danh sách của bạn', 'woocommerce'); ?></h4>
          <div class="description-cart"><?php _e('Đây là những dịch vụ bạn đã quan tâm','woocommerce')?></div>
      </div>
      <div class="widget_shopping_cart_content">
          <?php woocommerce_mini_cart(); ?>
      </div>
