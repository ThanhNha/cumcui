...
Flatsome_Option::add_field( 'option',  array(
	'type'        => 'text',
	'settings'     => 'follow_behance',
	'label'       => __( 'Behance', 'flatsome-admin' ),
	'transport' => $transport,
	'section'     => 'follow',
	'default'     => '',
));
...
function flatsome_refresh_social( WP_Customize_Manager $wp_customize ) {
  ...
  if ( ! isset( $wp_customize->selective_refresh ) ) {
	  ...
	  $wp_customize->selective_refresh->add_partial( 'follow_icons', array(
	    ...
	    'settings' => array('follow_linkedin','follow_flickr','follow_email','follow_phone','follow_style','follow_instagram','follow_facebook','follow_twitter','follow_tiktok','follow_rss','follow_vk','follow_youtube','follow_pinterest','follow_snapchat','follow_500px','follow_telegram','follow_twitch','follow_discord'),
