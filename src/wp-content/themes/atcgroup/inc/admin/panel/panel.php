...
class Flatsome_Admin {
	...
	public function flatsome_panel_register_menu() {
		add_menu_page( 'Welcome to ATC Group', 'ATC Group', 'manage_options', 'flatsome-panel', array( $this, 'flatsome_panel_welcome' ),get_stylesheet_directory_uri() . '/img/logo-admin.png', '2' );
