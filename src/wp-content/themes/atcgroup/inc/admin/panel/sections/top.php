...
<h1>
    <?php echo '<strong>Welcome to ATC Group</strong>'; ?>
</h1>
<div class="about-text">
<?php _e( 'Thanks for Choosing ATC Group - The worlds most powerful WooCommerce and Multi-Purpose Theme. This page will help you quickly get up and running with ATC Group.', 'flatsome-admin' ); ?>
    <br><br>
