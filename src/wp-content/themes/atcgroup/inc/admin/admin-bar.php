...
$flatsome_icon = '<img style="margin-top:-4px;vertical-align:middle;width:20px" src="'. get_stylesheet_directory_uri().'/img/logo-admin.png" content="noindex">';

$wp_admin_bar->add_menu( array(
 'id' => 'flatsome_panel',
 'title' => $flatsome_icon.' ATC Group',
 'href' => $panel_url
));
